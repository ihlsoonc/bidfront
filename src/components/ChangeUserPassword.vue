<template>
  <q-page padding>
    <q-card>
        ...
        <q-card-section>
          ...
          <div v-if="codeInputMode" class="q-mt-md">
            ...
            <div v-if="isValidTelno">
              ...
              <q-btn @click="changePassword" label="비밀번호 변경" color="primary" class="q-mt-md" />
              <q-btn @click="cancelChange" label="작업 취소" color="negative" class="q-mt-md" />
            </div>
          </div>
          <q-banner v-if="telmsg" class="bg-warning text-white q-mt-md">{{ telmsg }}</q-banner>
        </q-card-section>
      </q-tab-panel>
      ...
      <q-tab-panel name="changePassword">
        <q-card-section>
          ...
          <q-input
            ...
            :readonly="isValidated"
          />
          <q-btn @click="handleValidate" label="확인" color="primary" class="q-mt-md" />
      ...
      <q-banner v-if="message" class="bg-info text-white q-mt-md">{{ message }}</q-banner>
    </q-card>
  </q-page>
</template>
