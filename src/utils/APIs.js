...
export const APIs = reactive({
  ...
  GET_BIDS_BY_SEATARRAY: "http://localhost:5000/api/bid/get-by-seatarray",
  GET_MY_BIDS: "http://localhost:5000/api/bid/get-mybids",
  GET_MY_LASTBIDS: "http://localhost:5000/api/bid/get-mylastbids",
  GET_BID_TALLIES: "http://localhost:5000/api/bid/get-bid-tallies",
  GET_ALL_BIDS: "http://localhost:5000/api/bid/get-all-bids",
