...
export const APIs = reactive({
  ...
  SEND_KAKAO_ALIMTALK: `${baseURL}/api/sendkakao/send-kakao-message`, // 낙찰내용용 알림톡 전송
  ...
  GET_BID_TALLIES: `${baseURL}/api/bid/get-bid-tallies`, // 입찰자, 최고액 등  조회
  GET_ALL_BIDS: `${baseURL}/api/bid/get-all-bids`, // 모든 입찰 내역 조회
  GET_HIGHEST_BIDS: `${baseURL}/api/bid/get-highest-bids`, // 좌석별 최고 입찰 조회
  SUBMIT_BID: `${baseURL}/api/bid/submit`, // 입찰 제출
  SUBMIT_BATCH_BID: `${baseURL}/api/match/batch-bid-submit`, // 일괄 입찰 제출
  APPROVE_BATCH_BID: `${baseURL}/api/match/batch-bid-approve`, // 일괄 입찰 승인인
  ...
  GET_ALL_APPROVED_MATCHES: `${baseURL}/api/match/getallapproved`, // 승인된 모든 경기 조회
  ...
  GET_ALL_VENUES: `${baseURL}/api/venue/getall`, // 모든 경기장장 조회
